...
<div class="saig-cover">
  ...
  <details class="saig-cite">
    ...
    <div class="saig-cite-panel">
      ...
      <p>Jegham, N., Koh, C. Y., Gamazaychikov, B., &amp; Luccioni, S. (2026).
        <em>CLEER: Closed-model Latent Energy Estimation Range. Technical Report.</em>
        Sustainable AI Group. Version CLEER-Text-0926.
        <a href="https://reports.sustainableaigroup.com/CLEER-Tech-Report/">https://reports.sustainableaigroup.com/CLEER-Tech-Report/</a>
      </p>
  
      <strong>BibTeX</strong>
      <pre id="saig-bibtex">@misc{saig2026cleer,
...
#show heading.where(level: 1): it => block(above: 16pt, below: 6pt)[
...
#show heading.where(level: 3): it => block(above: 10pt, below: 5pt)[
  #text(font: "Inter", size: 11.5pt, weight: "medium", hyphenate: false, fill: rgb("#2B6572"))[#it.body]
]
...
<div class="kpi-grid">
  ...
  <div class="kpi"><div class="value">2,400+ tests</div><div class="label">20+ open models</div></div>
  <div class="kpi"><div class="value">425M+ tokens</div><div class="label">Empirically benchmarked</div></div>
</div>
```
...
: {tbl-colwidths="[24,46,15,15]"}

```{=typst}
#pagebreak()
```

# Annex A: Gemini Model Approach {#appendix-a---gemini-models-approach}
