...
::: {.figure-frame}
![Active versus total parameters for the top open-source models according to Artificial Analysis.](<assets/figure 1.svg>){#fig-active-total width=100%}
:::
...
::: {.figure-frame}
![Total versus pruned size of open-source models, in gigabytes.](<assets/figure 3.svg>){#fig-pruned-size width=100%}
:::
